...
const features = [
  {
    ...
    description: "Theo sát lộ trình được thiết kế riêng cho trình độ và mục tiêu của bạn.",
  },
  {
    icon: <MicrophoneIcon />,
    title: "AI Chấm phát âm",
    description: "Nhận phản hồi tức thì về phát âm của bạn với công nghệ AI tiên tiến.",
  },
  {
    icon: <ChartIcon />,
    title: "Theo dõi tiến độ",
    description: "Trực quan hóa sự tiến bộ của bạn qua các báo cáo chi tiết.",
  },
  {
    icon: <UsersIcon />,
    title: "Cộng đồng hỗ trợ",
    description: "Tham gia cộng đồng người học và giáo viên để cùng luyện tập và phát triển.",
  },
];
